...
var game = {
  ...
  var buildings = {
    ...
    purchase: function(index, clicked) {
      if (game.score >= this.cost[index]) {
        ...
        if (clicked) {
          play_sfx_sound(`${BASEURL}audio/sfx/misc-denied.mp3`)
          console.log("can not buy! current amount: "+game.score+" | desired amount: "+this.cost[index])
        }
      }
    },
  ...
  function detect_running_location() {
    // portable runs in a portable environment
    BASEURL = "https://cdn.jsdelivr.net/gh/s1887204/javascript-clicker-attempt@main/";
  };
